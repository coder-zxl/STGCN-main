...
from script import dataloader, utility, earlystopping,dataloader1
...
def data_preparate(dataset, gso_type, graph_conv_type, n_his, n_pred, batch_size, device):    
    ...
    s=dataloader1.Sequential_METR_LA([])
    train_iter, val_iter, test_iter, zscore = dataloader1.Sequential_METR_LA.get_data_loaders(s)
